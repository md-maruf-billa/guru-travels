            ...
            <div className='min-h-screen flex flex-col justify-center items-center  text-black'>
                <form className='bg-white px-14 py-10 rounded-lg'>
                    ...
                    <div className='flex flex-col w-[400px] gap-12'>
                        <input className='border-b-2 outline-none' type="text" placeholder='First Name' />
                        <input className='border-b-2 outline-none' type="text" placeholder='Last Name' />
                        ...
                        <input className='border-b-2 outline-none' type="password" placeholder='Confirm Password' />
                    </div>
